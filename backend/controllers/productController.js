...
const updateProduct = asyncHandler(async (req, res) => {
  ...
  if (product) {
    ...
    product.packed_weight = packed_weight;
    product.packed_size = packed_size;
    product.floor_dimensions = floor_dimensions;
    product.peak_height = peak_height;
